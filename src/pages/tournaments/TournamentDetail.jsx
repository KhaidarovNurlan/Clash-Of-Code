...
const TournamentDetail = () => {
  ...
  const fetchTournamentDetails = async () => {
    try {
      ...
      if (tournament.levels.length > 0) {
        const nextLevel =
          tournament.levels.find((l) => l.level_number === nextLevelNumber) ||
          tournament.levels[0];

        if (
          !currentLevel ||
          currentLevel.level_number !== nextLevel.level_number
        ) {
  ...
  return (
    <div className="animate-fadeIn mt-12 mb-12">
          ...
          <div className="flex-1">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <div className="flex items-center text-slate-300">
                ...
                <span>
                  Level {currentLevel.level_number} of{" "}
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <div className="card">
            <div className="p-4 border-b border-slate-700 flex items-center justify-between">
              ...
              >
                {tournament.languages.map((lang, index) => (
                  <option key={lang.id || lang.code || index} value={lang.code}>
                    {lang.name}
                  </option>
                ))}
              </select>
