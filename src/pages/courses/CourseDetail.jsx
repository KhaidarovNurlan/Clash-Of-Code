...
const CourseDetail = () => {
  ...
  const fetchCourseDetails = async () => {
    try {
      ...
      const completedLesson = courseResponse.data.lessons.find(
        (lesson) =>
          progressResponse.data.lessons?.find((l) => l.id === lesson.id)
            ?.completed
      );
    ...
    try {
      ...
      if (response.data.course_completed) {
        ...
        const nextLesson = lessons.find(
          (l) => l.id === currentLesson.navigation.next_id
        );
        if (nextLesson) {
              ...
              <div className="p-6">
                <div
                  ...
                  dangerouslySetInnerHTML={{
                    __html: currentLesson.contentHtml,
                  }}
                ></div>
